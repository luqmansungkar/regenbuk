<div class="container-fluid" style="background-color:#FFF;max-width:1300px;">
	...
	<div class="row slide category-box">
		<div class="row boxes">
			<div class="row" style="text-align:center"><span style=";color:#FDC142;font-size:28px"><?php echo $cari['kategori']; ?></span> <img src="http://placehold.it/60x60"></div>
			<hr />
			<div class="row">

				<div class="row" style="text-align:center">Sub-Kategori</div>
				<div class="col-md-offset-3 col-md-3 sub-category">
					<ul>
				...
				<div class="col-md-offset-1 col-md-3 sub-category">
					<ul>
