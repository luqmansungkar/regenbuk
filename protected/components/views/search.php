				...
				//print_r($provArray);
					...
					<div class="form-group">
						...
						<?php 
							...
							array('prompt'=>'Pilih Kategori','class'=>'form-control','placeholder'=>'Kategori',
						...
						echo CHtml::dropDownList('cari[sub_kategori]','',array(),array('prompt'=>'Pilih kategori terlebih dahulu','class'=>'form-control'));?>
